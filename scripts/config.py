...
if os.geteuid() == 501:
    data_directory = os.path.expanduser("~/GitHub/StrainPrevalence/data/")
    analysis_directory = os.path.expanduser("~/GitHub/StrainPrevalence/analysis/")
    scripts_directory = os.path.expanduser("~/GitHub/StrainPrevalence/scripts/")

    midas_directory = os.path.expanduser("~/GitHub/StrainPrevalence/data/midas_db_v1.2/")
    patric_directory = os.path.expanduser("~/GitHub/StrainPrevalence/data/patric_db/")
    metadata_directory = os.path.expanduser("~/GitHub/StrainPrevalence/scripts/metadata/")
