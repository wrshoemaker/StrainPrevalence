...
ax_strain.text(-0.1, 1.04, plot_utils.sub_plot_labels[0], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_strain.transAxes)
ax_ex.text(-0.1, 1.04, plot_utils.sub_plot_labels[1], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_ex.transAxes)
ax_corr.text(-0.1, 1.04, plot_utils.sub_plot_labels[2], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_corr.transAxes)
...
fig.savefig("%sslm_error_vs_strainfinder%s.pdf" % (config.analysis_directory, best_status), format='pdf', bbox_inches = "tight", pad_inches = 0.4, dpi=600)
plt.close()
