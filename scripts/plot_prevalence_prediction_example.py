...
clb_sc_ax_prevalence_eco.set_label('Number of sites', size=11)

#fig.colorbar(sc_ax_prevalence_eco, ax=ax_prevalence_eco)
#fig.colorbar.set_label(label='Number of sites', fontsize=11)
...
#clb.ax.tick_params(labelsize=8) 
clb_sc_ax_abundance_prevalence_eco.set_label('Number of sites', size=11)

#fig.colorbar(sc_ax_abundance_prevalence_eco, ax=ax_abundance_prevalence_eco)
#fig.colorbar.set_label(label='Number of sites', fontsize=11)

#import inspect
#print(inspect.getmembers(fig.colorbar))
